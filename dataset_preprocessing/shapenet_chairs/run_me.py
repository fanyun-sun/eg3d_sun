...
if __name__ == '__main__':
    with tempfile.TemporaryDirectory(prefix=os.getcwd()) as working_dir:
        download_name = 'chairs_train.zip'
        url = 'https://drive.google.com/uc?id=1f8UMmwLGRNuswSz-yXi-_FbzzLFqIKmP'
        output_dataset_name = 'chairs_128.zip'
